---
description: 了解贪心算法的基本理论，通过例题学习贪心算法的思想与实现代码
---
...
我们知道，贪心算法也是有优劣之分的，在某个方面过于贪心，也可能与最优解差之千里。这时候就需要适当取舍来保证最优解。对于此题来说，最优解取决于**不放当前宝物**以及**放当前宝物的代价（即减去代价之后的最优解）加上可得到的报酬**之间哪个值更大。
